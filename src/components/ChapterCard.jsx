 ...
 */
export default function ChapterCard({ chapter, index, unlocked, paymentLocked = false, rewardDaysLeft = null, progressPercent = 0 }) {
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[12px] text-[var(--color-muted)] mt-0.5">
            {paymentLocked
              ? 'Payment se unlock hoga'
              : rewardDaysLeft != null
              ? `⏰ Reward unlock — ${rewardDaysLeft}d left`
              : `${chapter.lessonCount} lessons · ${chapter.xpReward} XP`}
          </p>
        </div>
